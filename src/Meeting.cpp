...
Meeting::Meeting(const Meeting &t_meeting): m_sponsor(t_meeting.getSponsor()),
	m_participators(t_meeting.getParticipator()), m_startDate(t_meeting.getStartDate()),
	m_endDate(t_meeting.getEndDate()), m_title(t_meeting.getTitle()) {}
